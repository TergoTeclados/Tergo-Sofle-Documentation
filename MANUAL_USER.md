...
Caso tenha chegado aqui por acidente, veja todos manuais [clicando aqui](/README.md) ou conheça o produto no site [tecladoergonomico.com.br](tecladoergonomico.com.br).

Caso queira saber sobre ergonomia, consulte o [Manual de Ergonomia](/MANUAL_ERGONOMY.md).
...
Use a interface do Vial para entender facilmente cada camada.

### Modo básico de adepto
...
### Alterar entre modo "Basic" e "Adept"

Enquanto na camada de ajustes, altere o modo do teclado clicando "B".
