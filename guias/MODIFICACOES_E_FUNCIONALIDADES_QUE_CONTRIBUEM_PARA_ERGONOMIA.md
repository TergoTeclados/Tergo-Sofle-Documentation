...
## Sumário
  ...
  * [Sugestões de adaptações no layout do Tergo Sofle](#sugestões-de-adaptações-no-layout-do-tergo-sofle)
    ...
    + [Colocar duplo comportamento nas teclas do dedão para mudar de camada](#colocar-duplo-comportamento-nas-teclas-do-dedao-para-mudar-de-camada)
  * [Layouts de teclas além do QWERT](#layouts-de-teclas-alem-do-qwert)
