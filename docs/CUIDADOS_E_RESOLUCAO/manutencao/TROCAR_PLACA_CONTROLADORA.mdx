...
:::tip Leia também o guia

Recomendamos a leitura do guia junto ao vídeo para entender cuidados e detalhes finos durante o processo.

:::

<YouTubeVideo 
  videoId="jODsPcJ7b0g" 
  title="Tutorial de Troca de Placa Controladora"
  embed={true}
/>
...
Caso tenha dificuldades ou queira entender melhor como desmontar a estrutura do teclado, consulte o [guia de montagem](./MANUAL_DE_MONTAGEM_E_MANUTENCAO.mdx).
