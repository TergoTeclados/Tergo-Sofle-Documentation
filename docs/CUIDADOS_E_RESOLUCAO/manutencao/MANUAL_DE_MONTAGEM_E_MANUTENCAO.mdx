...
### Vídeo de montagem/desmontagem e troca do OLED/Controladora

Este vídeo te mostra o processo.

Ainda assim, recomendamos ler o guia para entender detalhes finos e cuidados que você deve ter.

<YouTubeVideo 
  videoId="jODsPcJ7b0g" 
  title="Tutorial de Montagem e Manutenção"
  embed={true}
/>
