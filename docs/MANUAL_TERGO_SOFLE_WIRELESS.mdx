...
:::tip Cuidados com bateria
Recomendamos uma inspeção anual da bateria. 

Verifique periodicamente se há sinais de estufamento (inchaço), vazamentos ou danos físicos.

Não é normal acontecer e nunca tivemos relatos disso, porém é um cuidado que se deve ter com baterias.

Caso note qualquer irregularidade, realize a troca imediata para evitar danos ao teclado.
:::
