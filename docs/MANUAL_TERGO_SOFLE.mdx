...
- **Manutenção e desmontagem**: Se precisar desmontar o teclado ou realizar manutenções, consulte primeiro o [manual de montagem e manutenção](./CUIDADOS_E_RESOLUCAO/manutencao/MANUAL_DE_MONTAGEM_E_MANUTENCAO.md) para fazer isso com segurança
:::
